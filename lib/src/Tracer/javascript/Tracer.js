...
Flog.RayTracer.Color.prototype = {
    add : function(c2){
      return new Flog.RayTracer.Color(this.red + c2.red,
				      this.green + c2.green,
				      this.blue + c2.blue);
    },
    ...
    multiplyScalar : function(f) {
      return new Flog.RayTracer.Color(this.red * f,
				      this.green * f,
				      this.blue * f);
    },
    ...
    blend: function(c, w){
        result = this.multiplyScalar(1 - w).add(c.multiplyScalar(w));
        return result;
    },
...
Flog.RayTracer.Vector.prototype = {
    ...
    add : function(w) {
        return new Flog.RayTracer.Vector(w.x + this.x, w.y + this.y, w.z + this.z);
    },

    subtract : function(w) {
        if(!w || !this) throw 'Vectors must be defined [' + this + ',' + w + ']';
        return new Flog.RayTracer.Vector(this.x - w.x, this.y - w.y, this.z - w.z);
    },
    ...
    multiplyScalar : function(w) {
        return new Flog.RayTracer.Vector(this.x * w, this.y * w, this.z * w);
    },
...
/*Flog.RayTracer.Material.Solid.prototype.*/getColor:{value:function(u, v){
  return this.color;
}},

/*Flog.RayTracer.Material.Solid.prototype.*/toString:{value:function () {
...
/*Flog.RayTracer.Material.Chessboard.prototype.*/getColor:{value:function(u, v){
...
/*Flog.RayTracer.Material.Chessboard.prototype.*/toString:{value:function () {
