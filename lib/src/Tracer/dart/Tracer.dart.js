...
["benchmark_base", "lib/src/common/dart/BenchmarkBase.dart", , V, {
  "^": "",
...
["ton80.tracer", "lib/src/Tracer/dart/Tracer.dart", , B, {
  "^": "",
  main: function() {
  ...
  renderScene: function($event) {
    ...
    scene.Scene$0();
    scene.camera = B.Camera$(C.Vector_0_0_m15, C.Vector_idk, C.Vector_0_1_0);
    scene.background = C.Background_waU;
    t1 = new B.Vector(0.1, 0.9, -0.5).normalize$0();
    scene.shapes.push(new B.Plane(1.2, t1, C.Chessboard_s8k));
    ...
    renderScene$2: function(scene, canvas) {
      ...
      for (; y < canvasHeight; ++y) {
        ...
        for (; x < canvasWidth; ++x) {
          ...
          t1 = this.getPixelColor$2(new B.Ray(new B.Vector(t5, t4, t6), new B.Vector(t3 / m, t2 / m, t1 / m)), scene);
          t2 = $.checkNumber;
      ...
      for (t1 = this.renderHighlights, t2 = this.renderShadows, t3 = depth <= this.rayDepth, t4 = this.renderDiffuse, t5 = this.renderReflections, t6 = ray.direction, t7 = t6.x, t8 = t6.y, t6 = t6.z, t9 = depth + 1, color = result, i = 0; t10 = scene.lights, i < t10.length; ++i) {
        ...
        if (t4) {
          ...
          if ($L > 0) {
            t16 = info.color;
            t17 = light.color;
            color = new B.Color(color.red + t16.red * (t17.red * $L), color.green + t16.green * (t17.green * $L), color.blue + t16.blue * (t17.blue * $L));
          }
        }
        if (t3)
          if (t5 && info.shape.material.reflection > 0) {
            ...
            reflectionRay = new B.Ray(t16, new B.Vector(t7 + t18 * t20, t8 + t19 * t20, t6 + t17 * t20));
            ...
            t18 = 1 - t17;
            result = new B.Color(color.red * t18 + t16.red * t17, color.green * t18 + t16.green * t17, color.blue * t18 + t16.blue * t17);
            color = result;
          }
        shadowInfo = new B.IntersectionInfo(false, 0, null, null, null, null, null);
        shadowInfo.color = C.Color_0_0_0;
        if (t2) {
          shadowInfo = this.testIntersection$3(new B.Ray(info.position, new B.Vector(t13, t15, t11)), scene, info.shape);
          if (shadowInfo.isHit) {
          ...
          if (t11) {
            ...
            result = new B.Color(color.red * 0.5 + dB, color.green * 0.5 + dB, color.blue * 0.5 + dB);
            result.limit$0();
            color = result;
          }
        }
        if (t1 && !shadowInfo.isHit && info.shape.material.gloss > 0) {
          ...
          t10 = light.color;
          color = new B.Color(t10.red * glossWeight + color.red, t10.green * glossWeight + color.green, t10.blue * glossWeight + color.blue);
        }
      }
  ...
  Scene: {
    ...
    Scene$0: function() {
      this.camera = B.Camera$(C.Vector_XjV, C.Vector_0_0_1, C.Vector_0_1_0);
      this.shapes = [];
      this.lights = [];
  ...
  Vector: {
    ...
    normalize$0: function() {
      ...
      return new B.Vector(t1 / m, t2 / m, t3 / m);
    },
    cross$1: function(w) {
...
C.Color_EuX = new B.Color(0, 0, 0.5);
C.Background_mKK = new B.Background(C.Color_EuX, 0.2);
C.Color_EuX0 = new B.Color(0.5, 0.5, 0.5);
C.Background_waU = new B.Background(C.Color_EuX0, 0.4);
C.Color_1_1_1 = new B.Color(1, 1, 1);
C.Color_0_0_0 = new B.Color(0, 0, 0);
C.Chessboard_s8k = new B.Chessboard(C.Color_1_1_1, C.Color_0_0_0, 0.7, 1, 0, 0.2, 0.5, true);
...
C.Vector_5_10_m1 = new B.Vector(5, 10, -1);
C.Color_LKl = new B.Color(0.8, 0.8, 0.8);
C.Light_ia3 = new B.Light(C.Vector_5_10_m1, C.Color_LKl, 10);
C.Vector_m3_5_m15 = new B.Vector(-3, 5, -15);
C.Light_yrN = new B.Light(C.Vector_m3_5_m15, C.Color_LKl, 100);
C.Vector_2nP = new B.Vector(-1.5, 1.5, 2);
C.Color_EuX1 = new B.Color(0, 0.5, 0.5);
C.Solid_AKg = new B.Solid(C.Color_EuX1, 2, 0, 0.3, 0, false);
C.Sphere_44Q = new B.Sphere(1.5, C.Vector_2nP, C.Solid_AKg);
C.Vector_rxi = new B.Vector(1, 0.25, 1);
C.Color_Fcu = new B.Color(0.9, 0.9, 0.9);
C.Solid_eNU = new B.Solid(C.Color_Fcu, 1.5, 0, 0.1, 0, false);
C.Sphere_gsm = new B.Sphere(0.5, C.Vector_rxi, C.Solid_eNU);
C.Vector_0_0_1 = new B.Vector(0, 0, 1);
C.Vector_0_0_m15 = new B.Vector(0, 0, -15);
C.Vector_0_1_0 = new B.Vector(0, 1, 0);
C.Vector_XjV = new B.Vector(0, 0, -0.5);
C.Vector_idk = new B.Vector(-0.2, 0, 5);
$.libraries_to_load = {};
