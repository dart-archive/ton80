...
["ton80.tracer", "Tracer.dart", , B, {
  ...
  Vector: {
    ...
    $sub: function(_, w) {
      return new B.Vector(this.x - w.get$x(), this.y - w.y, this.z - w.z);
    },
    $mul: function(_, w) {
      return new B.Vector(C.JSNumber_methods.$mul(this.x, w.get$x()), C.JSNumber_methods.$mul(this.y, w.get$y()), C.JSNumber_methods.$mul(this.z, w.get$z()));
    },
