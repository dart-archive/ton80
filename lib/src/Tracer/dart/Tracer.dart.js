...
["ton80.tracer", "Tracer.dart", , B, {
  "^": "",
  main: function() {
    var line = "Tracer(RunTime): " + H.S(new B.TracerBenchmark("Tracer").measure$0()) + " us.";
    H.printString(line);
  },
  renderScene: function($event) {
    var scene, t1, t2, t3, t4, raytracer;
    scene = new B.Scene(null, null, null, null);
    scene.Scene$0();
    scene.camera = B.Camera$(new B.Vector(0, 0, -15), new B.Vector(-0.2, 0, 5), new B.Vector(0, 1, 0));
    scene.background = new B.Background(new B.Color(0.5, 0.5, 0.5), 0.4);
    t1 = new B.Solid(new B.Color(0, 0.5, 0.5), 2, 0, 0.3, 0.5, false);
    t1.hasTexture = false;
    t1.refraction = 0;
    t2 = new B.Solid(new B.Color(0.9, 0.9, 0.9), 1.5, 0, 0.1, 0.5, false);
    t2.hasTexture = false;
    t2.refraction = 0;
    t3 = new B.Vector(0.1, 0.9, -0.5).normalize$0();
    t4 = new B.Chessboard(new B.Color(1, 1, 1), new B.Color(0, 0, 0), 0.7, 1, 0, 0.2, 0.5, false);
    t4.hasTexture = true;
    scene.shapes.push(new B.Plane(1.2, t3, t4));
    scene.shapes.push(new B.Sphere(1.5, new B.Vector(-1.5, 1.5, 2), t1));
    scene.shapes.push(new B.Sphere(0.5, new B.Vector(1, 0.25, 1), t2));
    scene.lights.push(new B.Light(new B.Vector(5, 10, -1), new B.Color(0.8, 0.8, 0.8), 10));
    scene.lights.push(new B.Light(new B.Vector(-3, 5, -15), new B.Color(0.8, 0.8, 0.8), 100));
    raytracer = new B.Engine(100, 100, 5, 5, true, true, true, true, 2, null);
  ...
  Color: {
    ...
    $add: function(_, c2) {
      return new B.Color(this.red + c2.get$red(), this.green + c2.green, this.blue + c2.blue);
    },
    toString$0: function(_) {
      var r, g, b;
  ...
  IntersectionInfo: {
    ...
    toString$0: function(_) {
      return "Intersection [" + H.S(this.position) + "]";
    }
  },
  Engine: {
    ...
    renderScene$2: function(scene, canvas) {
      var canvasHeight, canvasWidth, y, yp, x, xp, t1, t2, t3, t4, t5, t6, t7, pos, m;
      $.checkNumber = 0;
      this.canvas = null;
      ...
      for (; y < canvasHeight; ++y) {
        ...
        for (; x < canvasWidth; ++x) {
          ...
          t5 = t1.up;
          t6 = t5.y;
          t7 = t2.x - (t3.x * xp - t5.x * yp);
          t6 = t2.y - (t4 * xp - t6 * yp);
          t5 = t2.z - (t3.z * xp - t5.z * yp);
          pos = new B.Vector(t7, t6, t5);
          t6 *= -1;
          pos.y = t6;
          t1 = t1.position;
          t7 -= t1.x;
          t6 -= t1.y;
          t1 = t5 - t1.z;
          m = Math.sqrt(t7 * t7 + t6 * t6 + t1 * t1);
          t1 = this.getPixelColor$2(new B.Ray(pos, new B.Vector(t7 / m, t6 / m, t1 / m)), scene);
          t2 = $.checkNumber;
    ...
    testIntersection$3: function(ray, scene, exclude) {
      ...
      best = new B.IntersectionInfo(false, 0, null, null, null, null, null);
      best.color = new B.Color(0, 0, 0);
      best.distance = 2000;
    ...
    rayTrace$4: function(info, ray, scene, depth) {
      var t1, t2, result, shininess, t3, t4, t5, t6, t7, t8, t9, color, i, t10, light, t11, t12, t13, t14, t15, m, t16, $L, t17, t18, t19, t20, t21, reflectionRay, refl, shadowInfo, dB, m0, glossWeight;
      t1 = info.color;
      t2 = scene.background.ambience;
      result = new B.Color(t1.red * t2, t1.green * t2, t1.blue * t2);
      t2 = info.shape.material;
      shininess = Math.pow(10, t2.gloss + 1);
      for (t1 = this.renderHighlights, t2 = this.renderShadows, t3 = depth <= this.rayDepth, t4 = this.renderDiffuse, t5 = this.renderReflections, t6 = ray.direction, t7 = t6.x, t8 = t6.z, t9 = depth + 1, color = result, i = 0; t10 = scene.lights, i < t10.length; ++i) {
        light = t10[i];
        t10 = light.position;
        t11 = info.position;
        t12 = t10.x;
        ...
        t15 = t10.z;
        t11 = t15 - t11.z;
        m = Math.sqrt(t13 * t13 + t14 * t14 + t11 * t11);
        t13 /= m;
        t14 /= m;
        t11 /= m;
        if (t4) {
          t16 = info.normal;
          $L = t13 * t16.x + t14 * t16.y + t11 * t16.z;
          if ($L > 0) {
            t16 = info.color;
            t17 = light.color;
            t18 = t17.red;
            ...
            t21 = t16.green;
            t16 = t16.blue;
            color = new B.Color(color.red + t20 * (t18 * $L), color.green + t21 * (t19 * $L), color.blue + t16 * (t17 * $L));
          }
        }
        if (t3)
          if (t5 && info.shape.material.reflection > 0) {
            ...
            t20 = t6.y;
            t17 = t17.z;
            t21 = 2 * -(t18 * t7 + t19 * t20 + t17 * t8);
            reflectionRay = new B.Ray(t16, new B.Vector(t7 + t18 * t21, t20 + t19 * t21, t8 + t17 * t21));
            ...
            t20 = color.green;
            t21 = color.blue;
            result = new B.Color(t19 * t18 + t16.red * t17, t20 * t18 + t16.green * t17, t21 * t18 + t16.blue * t17);
            color = result;
          }
        shadowInfo = new B.IntersectionInfo(false, 0, null, null, null, null, null);
        shadowInfo.color = new B.Color(0, 0, 0);
        if (t2) {
          shadowInfo = this.testIntersection$3(new B.Ray(info.position, new B.Vector(t13, t14, t11)), scene, info.shape);
          if (shadowInfo.isHit) {
          ...
          if (t11) {
            ...
            t13 = color.green;
            t14 = color.blue;
            t16 = shadowInfo.shape.material;
            dB = 0.5 * Math.pow(t16.transparency, 0.5);
            result = new B.Color(t11 * 0.5 + dB, t13 * 0.5 + dB, t14 * 0.5 + dB);
            result.limit$0();
            color = result;
          }
        }
        if (t1 && !shadowInfo.isHit && info.shape.material.gloss > 0) {
          ...
          t10 = t11.y - t10.y;
          t15 = t11.z - t15;
          m = Math.sqrt(t12 * t12 + t10 * t10 + t15 * t15);
          t11 = scene.camera.position;
          t13 = info.shape.position;
          t14 = t11.x - t13.x;
          t16 = t11.y - t13.y;
          t13 = t11.z - t13.z;
          m0 = Math.sqrt(t14 * t14 + t16 * t16 + t13 * t13);
          t11 = t14 / m0 - t12 / m;
          t10 = t16 / m0 - t10 / m;
          t15 = t13 / m0 - t15 / m;
          m = Math.sqrt(t11 * t11 + t10 * t10 + t15 * t15);
          t12 = info.normal;
          t15 = P.max(t12.x * (t11 / m) + t12.y * (t10 / m) + t12.z * (t15 / m), 0);
          glossWeight = Math.pow(t15, shininess);
          t10 = light.color;
          t11 = t10.red;
          t12 = t10.green;
          t10 = t10.blue;
          color = new B.Color(t11 * glossWeight + color.red, t12 * glossWeight + color.green, t10 * glossWeight + color.blue);
        }
      }
      color.limit$0();
      return color;
  ...
  Ray: {
    ...
    toString$0: function(_) {
      return "Ray [" + H.S(this.position) + ", " + H.S(this.direction) + "]";
    }
  },
  Camera: {
    ...
    static: {Camera$: function(position, lookAt, up) {
        var t1 = new B.Camera(position, lookAt, up, null, null);
  ...
  Scene: {
    ...
    Scene$0: function() {
      this.camera = B.Camera$(new B.Vector(0, 0, -0.5), new B.Vector(0, 0, 1), new B.Vector(0, 1, 0));
      this.shapes = [];
      this.lights = [];
      this.background = new B.Background(new B.Color(0, 0, 0.5), 0.2);
    }
  },
  BaseShape: {
    "^": "Object;",
  ...
  Plane: {
    ...
    intersect$1: function(ray) {
      ...
      info = new B.IntersectionInfo(false, 0, null, null, null, null, null);
      info.color = new B.Color(0, 0, 0);
      t1 = this.position;
      t2 = ray.direction;
      Vd = t1.dot$1(t2);
      if (Vd === 0)
      ...
      t3 = this.material;
      if (t3.hasTexture) {
        vU = new B.Vector(t1.y, t1.z, -t1.x);
        vV = vU.cross$1(t1);
    ...
    toString$0: function(_) {
      return "Plane [" + H.S(this.position) + ", d=" + H.S(this.d) + "]";
    }
  },
  Sphere: {
    ...
    intersect$1: function(ray) {
      ...
      if ($D > 0) {
        ...
        t4 = -$B - Math.sqrt($D);
        info.distance = t4;
        t4 = t1.$add(t1, t3.multiplyScalar$1(t4));
        info.position = t4;
    ...
    toString$0: function(_) {
      return "Sphere [position=" + H.S(this.position) + ", radius=" + H.S(this.radius) + "]";
    }
  },
  Vector: {
    "^": "Object;x<,y,z",
    normalize$0: function() {
      ...
      t2 = this.y;
      t3 = this.z;
      m = Math.sqrt(t1 * t1 + t2 * t2 + t3 * t3);
      return new B.Vector(t1 / m, this.y / m, t3 / m);
    },
    cross$1: function(w) {
      ...
      t5 = w.x;
      t6 = this.x;
      return new B.Vector(-t1 * t2 + t3 * t4, t1 * t5 - t6 * t4, -t3 * t5 + t6 * t2);
    },
    dot$1: function(w) {
      return this.x * w.x + this.y * w.y + this.z * w.z;
    },
    $add: function(_, w) {
      return new B.Vector(w.get$x() + this.x, w.y + this.y, w.z + this.z);
    },
    $sub: function(_, w) {
      return new B.Vector(this.x - w.x, this.y - w.y, this.z - w.z);
    },
    multiplyScalar$1: function(w) {
      if (typeof w !== "number")
        return H.iae(w);
      return new B.Vector(this.x * w, this.y * w, this.z * w);
    },
    toString$0: function(_) {
