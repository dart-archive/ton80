...
["", "DeltaBlue.dart", , Z, {
  ...
  Variable: {
    ...
    removeConstraint$1: function(c) {
      H.IterableMixinWorkaround_removeWhereList(this.constraints, new Z.Variable_removeConstraint_closure(c));
      if (this.determinedBy === c)
        this.determinedBy = null;
    }
  },
  Variable_removeConstraint_closure: {
    "^": "Closure;c_0",
    call$1: function(e) {
      return this.c_0 === e;
    }
  ...
  Planner: {
    ...
    incrementalAdd$1: function(c) {
      var mark, overridden;
      mark = this.currentMark + 1;
      this.currentMark = mark;
      for (overridden = c.satisfy$1(mark); overridden != null; overridden = overridden.satisfy$1(mark))
        ;
    },
    ...
    makePlan$1: function(sources) {
      ...
      for (; sources.length > 0;) {
        c = sources.pop();
        if (c.output$0().mark !== mark && c.inputsKnown$1(mark)) {
          t1.push(c);
          c.output$0().mark = mark;
