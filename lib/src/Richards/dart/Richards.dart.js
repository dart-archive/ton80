...
["", "Richards.dart", , Y, {
  ...
  Richards: {
    ...
    static: {"^": "Richards_DATA_SIZE,Richards_COUNT,Richards_EXPECTED_QUEUE_COUNT,Richards_EXPECTED_HOLD_COUNT,Richards_ID_IDLE,Richards_ID_WORKER,Richards_ID_HANDLER_A,Richards_ID_HANDLER_B,Richards_ID_DEVICE_A,Richards_ID_DEVICE_B,Richards_NUMBER_OF_IDS,Richards_KIND_DEVICE,Richards_KIND_WORK"}
  },
  Scheduler: {
    ...
    release$1: function(id) {
      ...
      if (tcb == null)
        return tcb;
      tcb.state = tcb.state & 4294967291;
      t1 = tcb.priority;
      t2 = this.currentTcb;
      if (t1 > t2.priority)
        return tcb;
  ...
  TaskControlBlock: {
    ...
    toString$0: function(_) {
      return "tcb { " + H.S(this.task) + "@" + this.state + " }";
    },
    static: {"^": "TaskControlBlock_STATE_RUNNING,TaskControlBlock_STATE_RUNNABLE,TaskControlBlock_STATE_SUSPENDED,TaskControlBlock_STATE_HELD,TaskControlBlock_STATE_SUSPENDED_RUNNABLE,TaskControlBlock_STATE_NOT_HELD"}
  },
  Task: {
    "^": "Object;"
  },
